...
public class ERP_Functions {
	...
	String res;
		  ...
		  public String login(String username,String password){
		   ...
		   public String suppliers(String sname,String address,String city,String country,
					String cperson,String pnumber,String mail,String mnumber,String note) throws InterruptedException{
